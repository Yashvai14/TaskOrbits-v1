...
CREATE TABLE "DashboardPreference" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "kanbanEnabled" BOOLEAN NOT NULL DEFAULT true,
    "calendarEnabled" BOOLEAN NOT NULL DEFAULT false,
    "timelineEnabled" BOOLEAN NOT NULL DEFAULT false,
    "dailyPlanner" BOOLEAN NOT NULL DEFAULT false,
    "aiPanel" BOOLEAN NOT NULL DEFAULT false,
